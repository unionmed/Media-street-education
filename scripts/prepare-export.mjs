...
const document = (title, body, head = '') =>
  `<!doctype html><html lang="en" dir="ltr"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>${title} | Merit Way</title><meta name="robots" content="noindex">${head}<style>body{margin:0;background:#f7f5f0;color:#182b2a;font:18px/1.8 system-ui,sans-serif}main{max-width:700px;margin:15vh auto;padding:32px}h1{font-size:clamp(36px,6vw,64px);line-height:1.15;font-weight:500}a{color:inherit;text-underline-offset:5px;display:inline-block;padding:12px 0;margin-inline-end:24px}a:focus-visible{outline:3px solid #795c25;outline-offset:4px}small{letter-spacing:.15em}section{border-top:1px solid #dcded5;margin-top:32px;padding-top:24px}</style></head><body><main>${body}</main></body></html>`;
